...
@endsection
@section('subhead')
    If you've found your way here, don't fret—this the page I use for testing
@endsection
@section('metadata')
    <tr>
        <td>Published:&nbsp;&nbsp;</td>
...
@section('content')
    ...
    <div class="footnotes">
        ...
        <ol>
            <li id="fn:1">
                <p>FN1&nbsp;<a href="#fnref1:1" rev="footnote" class="footnote-backref">&#8617;</a></p>
            </li>
            <li id="fn:2">
                <p>FN2&nbsp;<a href="#fnref1:2" rev="footnote" class="footnote-backref">&#8617;</a></p>
            </li>
        </ol>
    </div>
    <script>
