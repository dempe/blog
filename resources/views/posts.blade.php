...
<main>
    <article>
        ...
        <ul class="content-list">
            ...
            <li>
                {{ \Carbon\Carbon::createFromTimestamp($post->getPublished())->format('Y-m-d') }}:&nbsp;&nbsp;<a href="{{ '/posts/' . $post->getSlug() }}">{{ $post->getTitle() }}</a>
            </li>
            @endforeach
        </ul>
    </article>
    ...
    <div class="footer-content">
        <table>
            <tr>
                ...
                <td>2023-02-05 23:02</td>
            </tr>
            <tr>
                <td class="table-key">Modified:&nbsp;&nbsp;</td>
                <td>2023-05-12 21:05</td>
            </tr>
        </table>
    </div>
</footer>
